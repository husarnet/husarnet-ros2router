...
| `DS_LISTENING_PORT` |  | By default is unset. Set it to a number between `0` to `65535` to activate DDS Router in the Discovery Server - Server config. You can set the Discovery Server ID to `0` (or other numbers) with the `DS_ID=0` env |
